'''
@File    :   train_cifar10_v2_2.py
@Time    :   2023/04/26 10:00
@Author  :   Hong Shijie
@Version :   2.2
@Note    :   在v2.1的基础上，使其可自主循环不同batch
'''
import os
...
for batch_size in batch_groups:
    ...
    state_load = torch.load('../results/model_e83_acc89.pth')
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer_b, step_size=3, gamma=0.5)
