'''
@File    :   train_cifar10_v3_4.py
@Time    :   2023/05/29 20:30
@Author  :   Hong Shijie
@Version :   1
@related :   cnn_dn_v1_2 backbone_v1 dn_torch_v6_10
@Note    :   在train_cifar10_v3.5的基础上,使数据可以写入excel中
'''
import os
...
from utils.concat.cnn_dn_v1_2 import concat_net
