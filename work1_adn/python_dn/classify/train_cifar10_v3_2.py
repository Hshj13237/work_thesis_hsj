...
@Time    :   2023/05/24 19:30
@Author  :   Hong Shijie
@Version :   3.2
@related :   cnn_dn_v1 dn_torch_v6_8
@Note    :   在v3.1的基础上,加入自适应神经元增长机制，当剩余的未激活神经元小于batch size时，增加神经元总数
'''
import os
...
def get_dir(saver_dir):
    cnt = 0
    while True:
        saver_f = os.path.join(saver_dir, 'cifar10_v3d2_')
