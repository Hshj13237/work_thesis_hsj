'''
@File    :   train_cifar10_v3.py
@Time    :   2023/05/21 15:00
@Author  :   Hong Shijie
@Version :   3
@related :   cnn_dn_v1 dn_torch_v6..
@Note    :   在v2.1的基础上，适用于基于教师学生模型方法的训练，同时增加了多组循环训练
'''
import os
...
def main():
    ...
    for epo in range(epochs):
        ...
        fc_acc, dn_acc = test(test_loader, model_dn, model_fc)
...
def test(test_loader, model_dn, model_fc):
