'''
@File    :   dn_torch_v7_1.py
@Time    :   2023/06/0 16:00
@Author  :   Hong Shijie
@Version :   7.1
@Note    :   在v6.12的基础上，
'''
        ...
        if mode == 'train':
            with torch.no_grad():
                for num in range(per_item):
                    ...
                    y_top_down_response = self.z2y(z)
                    ...
                    self.hebbian_learning(x, z, max_index, max_response, batch, per_item, num, lower_index, global_step)
                ...
                y_tr = self.top_k_competition(y_temp, 0)
