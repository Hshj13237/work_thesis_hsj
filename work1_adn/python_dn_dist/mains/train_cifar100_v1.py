...
def main():
    ...
    # model.dn = model.dn.to('cuda:1')
    # model.dn = model.dn.to('cuda:0')
    ...
    for epo in range(epochs):
        unrevised_activated_num = train(train_loader, model, optimizer_b, scheduler, optimizer_d, epo, save_dir)
...
def train(train_loader, model, optimizer_b, scheduler, optimizer_d, epo, save_dir):
