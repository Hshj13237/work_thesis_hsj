...
def main():
    ...
    state_load = model.backbone.load_pretrained_weights()
    ...
    for epo in range(epochs):
        ...
        train(train_loader, model, optimizer_b, scheduler, optimizer_d, epo, save_dir)
...
def train(train_loader, model, optimizer_b, scheduler, optimizer_d, epo, save_dir):
    ...
    for img, label in loop_train:
        ...
        #
        # model(img, label, 'lock_backbone', dn_items, epo)
        #
