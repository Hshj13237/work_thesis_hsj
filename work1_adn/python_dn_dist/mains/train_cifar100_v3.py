...
batch_size = 128
dn_input_dim = [1, 512]
img_input_dim = [1, 8192]
# y_neuron_num = batch_size * 10
y_neuron_num = 128
y_top_k = 1
y_bottom_up_percent = 0.49
z_neuron_num = 100
synapse_flag = False
dn_items = 1
learning_rate = 0.0001
datasets = 'Cifar100D0423'
version = '2'
save_path = '../results'
backbone_times = 1
...
def main():
    ...
    model = concat_net(batch_size, dn_input_dim, y_neuron_num, y_top_k, y_bottom_up_percent, z_neuron_num, synapse_flag, img_input_dim)
    ...
    for epo in range(epochs):
        ...
        if epo % 100 == 0 and epo != 0:
            model.dn.y_bottom_up_percent -= 0.01
