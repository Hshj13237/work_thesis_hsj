...
# 基础块
from torch.nn import Conv2d, BatchNorm2d, ReLU, MaxPool2d, AdaptiveAvgPool2d, Linear, AdaptiveMaxPool2d
import torchvision
...
class ResNet18(nn.Module):
    def __init__(self, num_classes=10) -> None:
        ...
        # self.maxpool2 = AdaptiveMaxPool2d(output_size=(1, 1))
        # self.avgpool2 = AdaptiveAvgPool2d(output_size=(4, 4))

        # self.conv1x1a = Conv2d(64, 4, kernel_size=1, stride=1, bias=False)
        # self.conv1x1b = Conv2d(128, 16, kernel_size=1, stride=1, bias=False)
        # self.conv1x1c = Conv2d(512, 256, kernel_size=1, stride=1, bias=False)
        #
        # self.conv1x1a.weight.data = torch.rand(self.conv1x1a.weight.data.shape)
        # self.conv1x1b.weight.data = torch.rand(self.conv1x1b.weight.data.shape)
        # self.conv1x1c.weight.data = torch.rand(self.conv1x1c.weight.data.shape)
    ...
    def forward(self, x, td=None):
        ...
        return x, temp_x, temp_x2, temp_x3
